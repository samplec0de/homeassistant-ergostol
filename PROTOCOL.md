...
| 9   | **СТОП**                                  | |
| 11  | «пульт активен» (стадийный обмен)         | стол шлёт стадии в dLo: 0 → клиент отвечает op-11; 2 → «готово, можно запрашивать высоту»; 5/7 → синхронизация base/min/max; 9/11 → выход из Hot. Приложение подтверждает стадии 0/5/9 ответным op-11 |
